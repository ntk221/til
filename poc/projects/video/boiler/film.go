...
func (o *Film) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for film")
	}
...
func (o *Film) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for film")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for film")
	}
