...
func (o *FilmCategory) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for film_category")
	}
...
func (o *FilmCategory) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for film_category")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for film_category")
	}
